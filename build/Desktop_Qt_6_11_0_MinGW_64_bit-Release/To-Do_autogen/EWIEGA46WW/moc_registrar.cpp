...
template <> constexpr inline auto registrar::qt_create_metaobjectdata<qt_meta_tag_ZN9registrarE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "registrar",
        "on_txtSenha_2_textChanged",
        "",
        "arg1",
        "on_txtLogin_editingFinished",
        "on_dbCriar_clicked",
        "on_pushButton_2_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_txtSenha_2_textChanged'
        QtMocHelpers::SlotData<void(const QString &)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 3 },
        }}),
        // Slot 'on_txtLogin_editingFinished'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_dbCriar_clicked'
...
void registrar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_txtSenha_2_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->on_txtLogin_editingFinished(); break;
        case 2: _t->on_dbCriar_clicked(); break;
